...
insert into person values(2,"Sanvi","H R",22);
insert into person values(3,"Shree","B R",22);
insert into person values(4,"Hitha","K",22);
...
insert into customers values(1,"neha","India","Delhi");

insert into customers values(2,"Sanvi","Maldivies","Male"),(3,"Shree","Australia","Canberra"),(4,"Hitha","India","Delhi");

select * from customers;

select * from customers where country="India" or country="Maldivies";
...
select * from bank_details where job is null and age<45;

select * from bank_details;

select * from bank_details where education ="primary" and job is null;

select * from bank_details where balance<0;

select age,job,balance  from bank_details where housing="no";
